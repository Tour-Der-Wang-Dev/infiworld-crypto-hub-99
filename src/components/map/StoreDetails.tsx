...
const StoreDetails = ({ store, onClose }: StoreDetailsProps) => {
  ...
  return (
    <div className="fixed right-4 top-24 z-20 w-80 bg-white rounded-lg shadow-lg p-4 border border-gray-200">
      ...
      <div className="mb-4">
        <h4 className="text-sm font-semibold mb-2">Accepted Cryptocurrencies</h4>
