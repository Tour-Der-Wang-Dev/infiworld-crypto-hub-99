...
const Signup = () => {
  return (
    <>
      <SEOHead
        title="สมัครสมาชิก INFIWORLD | แพลตฟอร์มคริปโต"
        description="สมัครสมาชิกกับ INFIWORLD - แพลตฟอร์มที่รวมบริการซื้อ-ขาย-เช่า, งานฟรีแลนซ์, การจอง, และแผนที่ร้านค้าที่รับคริปโต"
        canonicalUrl="/signup"
      />
      <div className="min-h-screen flex flex-col">
        ...
        <main className="flex-grow flex items-center justify-center p-4">
          <div className="w-full max-w-md bg-white rounded-lg shadow-lg p-6 sm:p-8 text-center">
            <h1 className="text-2xl font-bold mb-4">หน้าสมัครสมาชิก</h1>
